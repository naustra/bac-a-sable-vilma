...
Télécharge 10 images par mot depuis 4 sources différentes
"""
...
def main():
    ...
    print("=" * 80)
    print("🚀 TÉLÉCHARGEMENT MULTI-SOURCES - CORPS HUMAIN")
    print("=" * 80)
    print(f"📊 {len(parties_corps)} parties du corps à traiter")
    print(f"📸 10 images par partie = {len(parties_corps) * 10} images au total")
    print(f"⚡ Parallélisme: {min(20, len(parties_corps))} téléchargements simultanés")
    print("=" * 80)
